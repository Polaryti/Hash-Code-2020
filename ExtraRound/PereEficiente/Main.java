 ...
 */
public class Main {
    private final static String inputA = "inputA.in";
    private final static String inputB = "inputB.in";
    private final static String inputC = "inputC.in";
    private final static String inputD = "inputD.in";
    private final static String inputE = "inputE.in";
    ...
    public static void siguienteMejor() {
        ...
        /*
         * if (aux != null){ int tam = aux.seleccionados.size(); TreeSet<Libro> lista =
         * new TreeSet<Libro>(); for(int i = 0; i < tam; i++){ Libro aux2 =
         * aux.seleccionados.last(); punt[aux2.id] = 0; lista.add(aux2);
         * aux.seleccionados.remove(aux2); } aux.seleccionados = lista; }
         */
            ...
            for (int i = 0; i < tam; i++) {
                ...
                for (int j = 0; j < librerias.size(); j++) {
                    ...
                    if (!actual.equals(aux)) {
                        ...
                        if (saca) {
                            actual.lib.add(new Libro(aux2.id, 0));
                        }
                    }
                }
                lista.add(aux2);
